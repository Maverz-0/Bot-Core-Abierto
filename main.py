...
def send_welcome(message):
    bot.reply_to(message,
                 "Core Abierto? Yo te ayudaré a saberlo!\n\n-Usando /abierto podrás lanzar la pregunta a la que todos "
                 "podrán responder de una manera más fácil.\nCon presionar el botón SÍ o el botón NO podrás notificar "
                 "si Core Dumped está abierto o no a quien lo haya preguntado.")
